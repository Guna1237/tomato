...
final mockNotifications = [
  ...
  const AppNotification(
    id: '2',
    title: 'You earned 40 tomatos',
    body: 'Priya confirmed delivery. Your streak is now at 9 days.',
    time: '11:08 AM',
    day: 'Today',
  ...
  const AppNotification(
    ...
    body: 'A parcel near the gate needs a runner in the next 8 minutes. Bonus: 60 tomatos.',
    time: '9:42 AM',
    day: 'Today',
  ...
  const AppNotification(
    ...
    body: 'Rahul confirmed your delivery. Tomatos have been transferred.',
    time: '4:30 PM',
    day: 'Yesterday',
